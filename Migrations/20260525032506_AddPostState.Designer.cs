...
namespace BlogFlow.API.Migrations
{
    ...
    [Migration("20260525032506_AddPostState")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlogFlow.API.Models.Comment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("PostId", "DeletedAt")
                        .HasDatabaseName("ix_comments_post_id_deleted_at");
            ...
            modelBuilder.Entity("BlogFlow.API.Models.Post", b =>
                {
                    ...
                    b.HasIndex("State")
                        .HasDatabaseName("ix_posts_state");

                    b.HasIndex("AuthorId", "State", "DeletedAt")
                        .HasDatabaseName("ix_posts_author_id_state_deleted_at");
