        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Username_MinLength", "length(username) >= 3");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("ck_revoked_at_valid", "revoked_at IS NULL OR revoked_at >= created_at");
                    table.CheckConstraint("ck_token_expiration_future", "expires_at > created_at");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "ix_post_tags_tag_id_post_id",
                table: "post_tags",
                columns: new[] { "tag_id", "post_id" });
